...
class FilesAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.text_item_filelist, viewGroup, false);
...
public class TextRecordFragment extends Fragment implements View.OnClickListener, MediaRecorder.OnInfoListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.text_fragment_record, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mFilesAdapter.setOnFileListener(new FilesAdapter.OnFileListener() {
            ...
            public void onFile(File file) {
                ...
                ((TextMainActivity)getActivity()).changeFragment(TextFragment.class,bundle);
            }
        });
    ...
    void startRecord(){
        ...
        String filePath = getContext().getExternalFilesDir("sound") + "/record"+sdf.format(new Date())+".mp3";
...
//        }
    ...
    public void drawFiles() {
        File path = new File(Environment.getExternalStorageDirectory(),"Voice");
